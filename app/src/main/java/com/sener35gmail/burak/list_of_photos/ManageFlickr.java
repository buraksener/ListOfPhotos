...
public class ManageFlickr {
    ...
    private static final String APIKEY_SEARCH_STRING = "&api_key=acf6173f070a07dcb53c07f18130357b";
    ...
    public static ShowListOfPhotos.UIHandler uihandler;
    ...
    public static void getThumbnails(ArrayList<ImageContener> imgCon, ShowListOfPhotos.UIHandler uih) {
    ...
    public static class GetThumbnailsThread extends Thread {
        ShowListOfPhotos.UIHandler uih;
        ImageContener imgContener;

        public GetThumbnailsThread(ShowListOfPhotos.UIHandler uih, ImageContener imgCon) {
            this.uih = uih;
        ...
        public void run() {
            ...
            if (imgContener.thumb != null) {
                Message msg = Message.obtain(uih, ShowListOfPhotos.UIHandler.ID_UPDATE_ADAPTER);
                uih.sendMessage(msg);
    ...
    public static ArrayList<ImageContener> searchImagesByTag(ShowListOfPhotos.UIHandler uih, Context ctx, String tag) {
        uihandler = uih;
        ...
        try {
            ...
            try {
                ...
                Message msg = Message.obtain(uih, ShowListOfPhotos.UIHandler.ID_METADATA_DOWNLOADED);
                msg.obj = tmp;
                uih.sendMessage(msg);
            } catch (JSONException e) {
